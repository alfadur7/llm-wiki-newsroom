...
| `struct.theme-coverage` (X1) | theme coverage | every declared theme (including other-fragmentary) appears 1+ times as `[[<slug>\|Korean]]` | A | ✅ |
