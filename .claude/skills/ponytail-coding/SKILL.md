...
Vendored from [Ponytail](https://github.com/DietrichGebert/ponytail)
(`skills/ponytail/SKILL.md`) — © 2026 DietrichGebert, MIT License.

This project vendors the core behavioral skill only. The bundled hooks,
statusline, and companion commands (`/ponytail-audit|review|debt|gain|help`)
